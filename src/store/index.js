...
const store = new Vuex.Store({
  ...
  actions: {
    ...
    // async getResource({ commit }, i) {
    //   // console.log(this.state.reader.dir[i].pathV2);
    //   try {
    //     let { data } = await axios.get(this.state.reader.dir[i].pathV2, {
    //       responseType: "blob",
    //     });
